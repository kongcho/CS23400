...
if __name__ == '__main__':
    ...
    for i in [3, 25]:
        ...
        print("\tTrue True")
        print_num_detected_each_cat(folder, [True, True], 0.05, 0.01, 25, i, thres=0.8, group_by=[POSITIVE])
        print("\tTrue False")
        print_num_detected_each_cat(folder, [True, False], 0.05, 0.01, 25, i, thres=0.8, group_by=[POSITIVE])
        print("\tFalse True")
        print_num_detected_each_cat(folder, [False, True], 0.05, 0.01, 25, i, thres=0.8, group_by=[POSITIVE])
        print("\tFalse False")
        print_num_detected_each_cat(folder, [False, False], 0.05, 0.01, 25, i, thres=0.8, group_by=[POSITIVE])
